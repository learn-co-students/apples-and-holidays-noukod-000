...
array_symbol = []
holiday_hash.each do |season, season_name|
  season_name.each do |holiday, holiday_name|
    holiday_name.each do |season_supply|
     if season_supply == "BBQ"
        array_symbol.push(holiday)
      end
    end
  end
  end
